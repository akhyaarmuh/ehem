...
import { updateCategoryById } from '../../../api/categories';
import { ICategory, IUpdateCategory } from '../../../types/ICategory';
...
const ModalsUpdate: React.FC<ModalsProps> = ({ data, fetchData, idModals, idForm }) => {
  ...
  const [payload, setPayload] = useState<IUpdateCategory>(initialPayload);
  ...
  return (
    <Modals idModals={idModals} isSubmitting={isSubmitting}>
      <h3 className="font-bold text-lg mb-4">Ubah Kategori</h3>
