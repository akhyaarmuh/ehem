...
const idModalsUpdate = 'update-supplier';
const idFormUpdate = 'form-update-supplier';
const initialDataSelected = { id: '', name: '', address: '' };
...
const Suppliers = () => {
  ...
  const [dataSelected, setDataSelected] = useState<ISupplier>(initialDataSelected);
  ...
  const showModalsUpdate = (data: ISupplier) => {
